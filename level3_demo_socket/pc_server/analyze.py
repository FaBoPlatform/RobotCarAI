...
def main():
    ...
    # 動画読み込み準備
    vid = VideoReader(os.path.join(FILE_DIR, FILENAME))
    vid.init_write()
    ...
    try:
        while True:
            ...
            # カメラ画像に道路標識結果を描画する
            od.write_bboxes(cv_rgb,rclasses,rscores,rbboxes)
            # 道路をリサイズする
            ...
            vid.write_frame(to_bgr(cv_rgb_debug))
