...
class KerberosVL53L0X():
    ...
    def __init__(self):
        ...
        time.sleep(0.1)
        sensor1 = VL53L0X.VL53L0X(i2c_bus=0,i2c_address=0x29)
        ...
        time.sleep(0.1)
        sensor2 = VL53L0X.VL53L0X(i2c_bus=0,i2c_address=0x29)
        ...
        time.sleep(0.1)
        sensor3 = VL53L0X.VL53L0X(i2c_bus=0,i2c_address=0x29)
